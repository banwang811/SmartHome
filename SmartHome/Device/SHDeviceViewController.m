...
@interface SHDeviceViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)reloadData
{
    for (int i= 0; i < 20; i ++)
    {
        NSString *str = [[NSString alloc] initWithFormat:@"设备%d",i];
        SHDeviceModel *model = [SHDeviceModel itemWithTitle:str iconName:@""];
